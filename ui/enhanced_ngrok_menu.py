...
class EnhancedNgrokMenu(EnhancedMenu):
 ...
 if self.ngrok_manager.external_target_mode:
 print(f"\n{Colors.RED} Warning: External target mode is currently ACTIVE{Colors.RESET}")
 ...
 print(f"\n{Colors.RED} Warning: This will stop ALL {len(tunnels)} active tunnel(s){Colors.RESET}")
